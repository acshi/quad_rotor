#![doc = "Peripheral access API for ATSAMD21E16L microcontrollers (generated using svd2rust v0.14.0)\n\nYou can find an overview of the API [here].\n\n[here]: https://docs.rs/svd2rust/0.14.0/svd2rust/#peripheral-api"]
#![deny(missing_docs)]
#![deny(warnings)]
...
#[doc = "Analog Comparators"]
pub mod ac;
#[doc = "Analog Comparators 1"]
pub struct AC1 {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for AC1 {}
impl AC1 {
    #[doc = r" Returns a pointer to the register block"]
    pub fn ptr() -> *const ac::RegisterBlock {
        1107317760 as *const _
    }
}
impl Deref for AC1 {
    type Target = ac::RegisterBlock;
