...
impl CAPTURER {
    ...
    pub fn is_captmark(&self) -> bool {
        *self == CAPTURER::CAPTMARK
    }
}
#[doc = r" Value of the field"]
pub struct BLANKPRESCR {
    bits: bool,
}
impl BLANKPRESCR {
    #[doc = r" Value of the field as raw bits"]
...
impl<'a> _CAPTUREW<'a> {
    ...
    pub fn captmark(self) -> &'a mut W {
        self.variant(CAPTUREW::CAPTMARK)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub fn bits(self, value: u8) -> &'a mut W {
...
#[doc = r" Proxy"]
pub struct _BLANKPRESCW<'a> {
    w: &'a mut W,
}
impl<'a> _BLANKPRESCW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 15 - Fault A Blanking Prescaler"]
    #[inline]
    pub fn blankpresc(&mut self) -> _BLANKPRESCW {
        _BLANKPRESCW { w: self }
    }
    #[doc = "Bits 16:23 - Fault A Blanking Time"]
    #[inline]
