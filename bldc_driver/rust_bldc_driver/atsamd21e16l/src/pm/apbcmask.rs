...
impl R {
    ...
    #[doc = "Bit 21 - AC1 APB Clock Enable"]
    #[inline]
    pub fn ac1_(&self) -> AC1_R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 21;
            ((self.bits >> OFFSET) & MASK as u32) != 0
